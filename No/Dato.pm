...
datoer pÂ norsk.  Dette gjelder blandt annet Â finne fram til de
norske helligdagene.
...
det er en vanlig hverdag sÂ vil en tom streng (som er FALSE i perl)
bli returnert.
...
Denne rutinen vil returnere en linje for hver helligdag i Âret gitt
som argument.  Hvis argumentet mangler vil vi bruke innevÊrende Âr.
Hver linje er pÂ formen:
